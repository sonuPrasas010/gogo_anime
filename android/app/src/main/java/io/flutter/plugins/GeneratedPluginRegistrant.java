...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.rebeloid.unity_mediation.UnityMediationPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin unity_mediation, com.rebeloid.unity_mediation.UnityMediationPlugin", e);
    }
    try {
